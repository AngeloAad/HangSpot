...
export function UserFollowButton({
  ...
  const followUserMutation = trpc.users.follow.useMutation({
    onMutate: async ({ id }) => {
      function updateUser<
        T extends {
          isFollowing: boolean;
  ...
  const unFollowUserMutation = trpc.users.unfollow.useMutation({
    onMutate: async ({ id }) => {
      function updateUser<
        T extends {
          isFollowing: boolean;
  ...
  if (!currentUser || currentUser.id === targetUsetId) return null;
