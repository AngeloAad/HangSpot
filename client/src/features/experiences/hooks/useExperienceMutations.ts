...
export function useExperienceMutations(
  ...
  const addExperienceMutation = trpc.experiences.add.useMutation({
    onSuccess: async ({ id }) => {
      toast({
  ...
  const deleteExperienceMutation = trpc.experiences.delete.useMutation({
    onSuccess: async (id) => {
      await Promise.all([
  ...
  const attendExperienceMutation = trpc.experiences.attend.useMutation({
    onMutate: async ({ id }) => {
  ...
  const unattendExperienceMutation = trpc.experiences.unattend.useMutation({
    onMutate: async ({ id }) => {
      function updateExperience<
        T extends {
          isAttending: boolean;
  ...
  const favoriteExperienceMutation = trpc.experiences.favorite.useMutation({
    onMutate: async ({ id }) => {
      function updateExperience<
        T extends {
          isFavorited: boolean;
  ...
  const unfavoriteExperienceMutation = trpc.experiences.unfavorite.useMutation({
    onMutate: async ({ id }) => {
      function updateExperience<
        T extends {
          isFavorited: boolean;
