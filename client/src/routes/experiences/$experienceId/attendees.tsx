  ...
  loader: async ({ params, context: { trpcQueryUtils } }) => {
    try {
      await Promise.all([
        ...
        trpcQueryUtils.users.experienceAttendees.ensureData({
...
function ExperienceAttendeesPage() {
  ...
  const [{ pages }, experienceAttendeesQuery] =
  ...
  return (
    <main className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <InfiniteScroll onLoadMore={experienceAttendeesQuery.fetchNextPage}>
          <UserList
