// Moved the old tRPC.ts file into this router.tsx file because we are setting up now tRPC + Tanstack Router
...
export const trpcClient = trpc.createClient({
  links: [
    ...
    splitLink({
      condition(op) {
        // Checks if the operation input contains non-JSON-serializable data (like FormData, Blob, etc)
        // to determine whether to use a regular HTTP link (true) or batched HTTP link (false)
